...
def embed_message(id, path, message):
        ...
        for x in range(width):
            ...
            for c in range(3):
                ...
                if message_index >= len(binary_message):
                    ...
                    cv2.imwrite('embedded_image/embedded_'+ id +'_image.png', image)
                    return 'embedded_image/embedded_'+ id +'_image.png'
...
# path = 'original_image/original_1_phpwgLBkG.png'
# message = 'aku adalah seorang programmer'

# enkripsi = encrypt(message)
# print(enkripsi)

# embedded_image = embed_message("2", path, enkripsi)

# extranct_image = extract_message('embedded_image/embedded_2_image.png')
